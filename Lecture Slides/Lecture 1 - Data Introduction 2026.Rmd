...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}
    \begin{figure}
    	\centering
    	\includegraphics[width=3cm]{../images/david-card.jpg}\\
    \end{figure}
  ...
  \begin{column}{0.5\textwidth}
    \begin{figure}
    	\centering
    	\includegraphics[width=3cm]{../images/Krueger.jpeg}\\
    \end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=8cm]{../images/Embrace.jpg}\\
\end{figure}
\
\begin{columns}
  \begin{column}{0.5\textwidth}
...
\begin{columns}
  ...
  \begin{column}{0.2\textwidth}
    \begin{figure}
    	\centering
    	\includegraphics[width=2cm]{../images/Rimage.jpeg}\\
    \end{figure}
...
\begin{columns}
  ...
  \begin{column}{0.2\textwidth}
    \begin{figure}
    	\centering
    	\includegraphics[width=2cm]{../images/RStudio_image.png}\\
    \end{figure}
...
\begin{columns}
  ...
  \begin{column}{0.2\textwidth}
    \begin{figure}
    	\centering
    	\includegraphics[width=2cm]{../images/ECLR.jpg}\\
    \end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=12cm]{../images/RStudio_screen.jpg}\\
\end{figure}
...
We can do this if we can argue/believe in the exogeneity assumption using OLS. Unfortunately we will often have to accept that it is breached (see previous slide). The methodological part of this unit introduces various standard techniques that allow us to deal with certain breaches of this assumption:

* First Difference                                                                         
* Diff-in-Diff, to be used in Project
* Instrumental Variables
* Regression Discontinuity (not in this unit)
...
![](../images/2x2slide1.PNG)

## DiD

![](../images/2x2slide2.PNG)

## DiD

![](../images/2xTslide1.PNG)

## DiD

![](../images/2xTslide2.PNG)

## DiD

![](../images/2xTslide3.PNG)

## DiD

![](../images/2xTslide4.PNG)
...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}
    ...
    But you cannot chose this topic for your own project. And your projects will have different features\\ See details in "Group Project Details" on Canvas
    \normalsize
  ...
  \begin{column}{0.5\textwidth}
    \begin{figure}
    	\centering
    	\includegraphics[width=5cm]{../images/SiegelExtract.png}\\
    \end{figure}
