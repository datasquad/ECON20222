...
This Computer Lab assumes that you have R and RStudio installed on your computer. If not, you will have to do that first. See, for instance, the advice on [ECLR](https://datasquad.github.io/ECLR/#Basic_techniques).

# Prepare your Workspace

Before you start you should create a space (i.e. a folder) on your computer from where you are planning to do all your R work. Make sure you understand where that folder is and that you know the path to that folder (Apple users, if you do not know how to find the path to a particular folder, then look at this [Piazza post @6](https://piazza.com/class/mk6lt8np9adl3/post/6)). If you are using a computer lab computer you should create a folder for your R work on your OneDrive. This will be accessible to you whenever you log on to a University computer, or from anywhere via your [office.com](Office.com access).
...
![A function is like a drink machine.](../images/DrinkMachine.png)
...
![RStudio Environment saves variables](../images/RStudio_Env2.png)
...
> Note: If you are working on a University computer then these libraries should already be pre-installed and you do not need to install them.
...
![RStudio Environment - execute lines of code](../images/RStudio_Image1.png)
...
* `CKdata$CHAIN` did address the `CHAIN` variable in the `CKdata` dataset (in general: `DATASET$VARIABLE`).
* `c("CHAIN","STATE")` allowed us to access two particular variables, ignoring all other 44 variables. It is useful to know what `c("CHAIN","STATE")` actually does as we will use that type of expression a lot.
...
> Challenge: For those of you who have had a lot of exposure to R or coding in another language (e.g. Python) you can challenge yourself to creating different summary statistics for the variables in the dataset.
